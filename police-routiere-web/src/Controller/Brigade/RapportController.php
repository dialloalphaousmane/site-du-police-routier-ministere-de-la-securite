...
class RapportController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $rapports = $this->rapportRepository->findBy(['brigade' => $brigade], ['dateCreation' => 'DESC']);

        return $this->render('brigade/rapport/index.html.twig', [
            'rapports' => $rapports,
            'user' => $user,
        ]);
    }

    #[Route('/new', name: 'app_rapport_new')]
    public function new(Request $request): Response
    {
        ...
        $rapport = new Rapport();
        $rapport->setAuteur($user);
        $rapport->setBrigade($brigade);
        ...
        return $this->render('brigade/rapport/new.html.twig', [
            'rapport' => $rapport,
