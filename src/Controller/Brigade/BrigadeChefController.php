...
class BrigadeChefController extends AbstractController
{
    ...
    public function dashboard(): Response
    {
        ...
        $infractions = $this->infractionRepository->countByBrigade($brigade);
        $amendes = $this->amendeRepository->countByBrigade($brigade);

        $stats = [
            'agents_count' => count($agents),
            'controls_count' => $this->controleRepository->countByBrigade($brigade),
            'infractions_count' => $infractions,
            'amendes_count' => $amendes,
            'amendes_pending' => $this->amendeRepository->countPendingByBrigade($brigade),
        ];
    ...
    public function controls(Request $request): Response
    {
        ...
        $total = $this->controleRepository->countByBrigade($brigade);
    ...
    public function infractions(Request $request): Response
    {
        ...
        $total = $this->infractionRepository->countByBrigade($brigade);
        $totalPages = (int) ceil($total / $limit);
